...
<html lang="pt-br">
    ...
    <body>
        ...
        <main>            
            ...
            <table class="striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Cristian Pereira</td>
                        <td>cristianpereira300@gmail.com</td>
                        <td>Recepcionista</td>
                        <td>
                            <center>
                                <a href="#"><i class="material-icons table-icon-edit" onclick="editItem()">create</i></a>
                    ...
                    <tr>
                        <td>Laura Scarlet</td>
                        <td>laurascarlet@hotmail.com</td>
                        <td>Massagista</td>
                        <td>
                            <center>
                                <a href="#"><i class="material-icons table-icon-edit" onclick="editItem()">create</i></a>
        ...
        <script type="text/javascript" src="../js/funcionarios-visualizacao.js"></script>
    </body>
</html>
