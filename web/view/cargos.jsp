...
<%
    ...
    Programa [] programasEncontrados = programaDAO.busca();
%>
    ...
    <body>
        ...
        <main>            
            ...
            <div class="card-action right-align button-box">
                <button data-target="modal-add-item" id="add-button" class="btn waves-effect waves-light modal-trigger"><i class="material-icons left">add_circle_outline</i>Novo Cargo</button>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="frmInsertItem" method="post">
                        ...
                        <div class="card-action right-align button-box">
                            ...
                            <button id="submit-button" class="btn waves-effect waves-light" onclick="saveInsertDialog()"><i class="material-icons left">check_circle_outline</i>Salvar cargo</button>
            ...
            <div id="modal-delete-item" class="modal">
                <div class="modal-content">
                    ...
                    <form id="frmDeleteItem" method="post">
                        ...
                        <!-- O ID E O NAME DEVEM SER OS MESMOS QUE SERÃO INFORMADOS NO SERVLET! MANTER PADRAO CAMEL CASE-->
                        <!-- ID USADO NO JSON -->
                        <input type="hidden" id="codCargo" name="codCargo">
                        <div id="modal-container">
                            <p>Tem certeza que deseja excluir o cargo selecionado? Se sim, confirme sua senha no campo abaixo:</p>
                            <div class="row">
                                <div class="col s12 form-input">
                                    <div class="input-field">
